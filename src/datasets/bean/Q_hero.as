...
public class Q_hero extends Bean {
    ...
    /** 攻击成长 */
    private var _q_gongji_g:int;
    /** 防御 */
    private var _q_fangyu:int;
    /** 防御成长 */
    private var _q_fangyu_g:int;
    /** 谋略 */
    private var _q_moulve:int;
    /** 谋略成长 */
    private var _q_moulve_g:int;
    /** 速度 */
    private var _q_sudu:int;
    /** 速度成长 */
    private var _q_sudu_g:int;
    /** 攻城 */
    private var _q_gongcheng:int;
    /** 攻城成长 */
    private var _q_gongcheng_g:int;
    /** 默认技能 */
    ...
    override public function read(_buf:ByteArray): void {
        ...
        this._q_gongji_g = readInt(_buf);
        this._q_fangyu = readInt(_buf);
        this._q_fangyu_g = readInt(_buf);
        this._q_moulve = readInt(_buf);
        this._q_moulve_g = readInt(_buf);
        this._q_sudu = readInt(_buf);
        this._q_sudu_g = readInt(_buf);
        this._q_gongcheng = readInt(_buf);
        this._q_gongcheng_g = readInt(_buf);
    ...
    public function get q_gongji_g():int {
        return _q_gongji_g;
    }
    public function get q_fangyu():int {
        return _q_fangyu;
    }
    public function get q_fangyu_g():int {
        return _q_fangyu_g;
    }
    public function get q_moulve():int {
        return _q_moulve;
    }
    public function get q_moulve_g():int {
        return _q_moulve_g;
    }
    public function get q_sudu():int {
        return _q_sudu;
    }
    public function get q_sudu_g():int {
        return _q_sudu_g;
    }
    public function get q_gongcheng():int {
        return _q_gongcheng;
    }
    public function get q_gongcheng_g():int {
        return _q_gongcheng_g;
    }
