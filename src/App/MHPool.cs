...
namespace App
{
    public class MHPool
    {
        public const string VERSION = "333f73d6d9e20fbcd30be3e7bfac9a6b";
        ...
        private MHPool()
        {
            ...
            Register(381, new App.PacketHandler.Guanqia.ResGuanQiaFightErrorPacketHandler(), typeof(App.PacketMessage.Guanqia.ResGuanQiaFightErrorPacketMessage));
            ...
            Register(380, new App.PacketHandler.Guanqia.ResGuanQiaFightPacketHandler(), typeof(App.PacketMessage.Guanqia.ResGuanQiaFightPacketMessage));
